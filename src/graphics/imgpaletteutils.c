...
static BOOL isColorCategory(UBYTE r, UBYTE g, UBYTE b, UBYTE category)
{
    ...
    if (total < 30)
        return FALSE; /* Very dark colors treated as neutral */
...
)
{
    ...
    if (colorMap)
    {
        ...
        systemPalette[0].r = 11;
        systemPalette[0].g = 10;
        systemPalette[0].b = 11; // Black (index 0)
        systemPalette[1].r = 39;
        systemPalette[1].g = 163;
        systemPalette[1].b = 32; // Green
        systemPalette[2].r = 146;
        systemPalette[2].g = 146;
        systemPalette[2].b = 146; // Gray
        systemPalette[3].r = 144;
        systemPalette[3].g = 220;
        systemPalette[3].b = 113; // Light green
